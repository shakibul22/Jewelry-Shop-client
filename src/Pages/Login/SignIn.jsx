...
const SignIn = () => {
  ...
  let from = location.state?.from?.pathname || "/";
    ...
    return (
       <div className='flex flex-col md:flex-row sm:flex-col justify-content-center align-items-center mt-10 md:mt-20 '>
         ...
         <form onSubmit={handleLogin} className="w-full md:w-[570px] mt-15 mb-10 p-10  bg-white rounded-lg text-black">
            ...
            <p className='text-center'>Don't have an account? <Link to='/sign-up' className='text-warning underline'>Create an account</Link></p>
