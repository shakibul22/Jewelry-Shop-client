...
const Footer = () => {
   ...
   <>
        ...
        <aside>
   <p className='text-2xl'>Jewelry Shop</p>
    <p>Jewelry Industries Ltd.<br/>Providing reliable tech since 1992</p>
  </aside> 
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">Phone:01843754582</a> 
    <a className="link link-hover">Location:Bashundhara,Dhaka</a> 
    <a className="link link-hover">Mail:Jewely.com</a>
  </nav> 
...
<footer className="footer footer-center p-10 bg-cyan-400 text-white">
  <aside>
    ...
    <p className="font-bold">
      Jewelry Industries Ltd. <br/>Providing reliable tech since 1992
    </p> 
